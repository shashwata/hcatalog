...
import com.google.common.base.Equivalence11;
...
public final class CacheBuilder<K, V> {
  ...
  Equivalence11<Object> keyEquivalence;
  Equivalence11<Object> valueEquivalence;
...
//
   ...
   *
   * <p>By default, the cache uses {@link Equivalence11#identity} to determine key equality when
   * {@link #weakKeys} is specified, and {@link Equivalence11#equals()} otherwise.
   */
  @GwtIncompatible("To be supported")
  CacheBuilder<K, V> keyEquivalence(Equivalence11<Object> equivalence) {
    checkState(keyEquivalence == null, "key equivalence was already set to %s", keyEquivalence);
    keyEquivalence = checkNotNull(equivalence);
    return this;
  }

  Equivalence11<Object> getKeyEquivalence() {
   ...
   *
   * <p>By default, the cache uses {@link Equivalence11#identity} to determine value equality when
   * {@link #weakValues} or {@link #softValues} is specified, and {@link Equivalence11#equals()}
   * otherwise.
   */
  @GwtIncompatible("To be supported")
  CacheBuilder<K, V> valueEquivalence(Equivalence11<Object> equivalence) {
  ...
  Equivalence11<Object> getValueEquivalence() {
  ...
  Ticker getTicker(boolean recordsTime) {
    ...
    return recordsTime ? SYSTEM_TICKER : NULL_TICKER;
  }
