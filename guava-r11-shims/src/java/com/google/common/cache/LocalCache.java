...
//  static final ListeningExecutorService sameThreadExecutor = MoreExecutors.sameThreadExecutor();
  static final ExecutorService sameThreadExecutor = MoreExecutors.sameThreadExecutor();
  ...
  final Equivalence11<Object> keyEquivalence;

  /** Strategy for comparing values. */
  final Equivalence11<Object> valueEquivalence;
  ...
  enum Strength {
    ...
    STRONG {
      ...
      @Override
      Equivalence11<Object> defaultEquivalence() {
        return Equivalence11.equals();
      }
    },
     ...
     * alternate strategy.
     */
    abstract Equivalence11<Object> defaultEquivalence();
  }
  ...
  static class ManualSerializationProxy<K, V>
    ...
    private ManualSerializationProxy(
        ...
        Equivalence11<Object> keyEquivalence, Equivalence11<Object> valueEquivalence,
      ...
      this.ticker = (ticker == CacheBuilder.SYSTEM_TICKER || ticker == NULL_TICKER)
          ? null : ticker;
      this.loader = loader;
    }
