...
@Beta
@GwtCompatible
final class FunctionalEquivalence11<F, T> extends Equivalence11<F>
    implements Serializable {

  private static final long serialVersionUID = 0;

  private final Function<F, ? extends T> function;
  private final Equivalence11<T> resultEquivalence;

  FunctionalEquivalence11(
      Function<F, ? extends T> function, Equivalence11<T> resultEquivalence) {
  ...
  @Override public boolean equals(/*@Nullable*/ Object obj) {
    ...
    if (obj instanceof FunctionalEquivalence11) {
      FunctionalEquivalence11<?, ?> that = (FunctionalEquivalence11<?, ?>) obj;
