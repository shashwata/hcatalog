 ...
 */
@GwtCompatible
public abstract class Equivalence11<T> {
  /**
   * Constructor for use by subclasses.
   */
  protected Equivalence11() {}
   ...
   * @since 10.0
   */
  public final <F> Equivalence11<F> onResultOf(Function<F, ? extends T> function) {
    return new FunctionalEquivalence11<F, T>(function, this);
  }
   ...
   * {@link Equivalence11}.
   *
   * <p>For example, given an {@link Equivalence11} for {@link String strings} named {@code equiv}
  ...
  public static final class Wrapper<T> implements Serializable {
    private final Equivalence11<? super T> equivalence;
    /*@Nullable*/ private final T reference;

    private Wrapper(Equivalence11<? super T> equivalence, /*@Nullable*/ T reference) {
    ...
    /**
     * Returns {@code true} if {@link Equivalence11#equivalent(Object, Object)} applied to the wrapped
    ...
    @Override public boolean equals(/*@Nullable*/ Object obj) {
      if (obj == this) {
        ...
        Equivalence11<Object> equivalence = (Equivalence11<Object>) this.equivalence;
    ...
    /**
     * Returns the result of {@link Equivalence11#hash(Object)} applied to the the wrapped reference.
     */
  ...
  public final <S extends T> Equivalence11<Iterable<S>> pairwise() {
    // Ideally, the returned equivalence would support Iterable<? extends T>. However,
    // the need for this is so rare that it's not worth making callers deal with the ugly wildcard.
    return new PairwiseEquivalence11<S>(this);
  }
  ...
  private static final class EquivalentToPredicate<T> implements Predicate<T>, Serializable {
    ...
    private final Equivalence11<T> equivalence;
    /*@Nullable*/ private final T target;

    EquivalentToPredicate(Equivalence11<T> equivalence, /*@Nullable*/ T target) {
      this.equivalence = checkNotNull(equivalence);
      this.target = target;
    }
   ...
   * {@link Equivalence11#equivalent} returns {@code true} if both values are null, or if neither
   * value is null and {@link Object#equals} returns {@code true}. {@link Equivalence11#hash} returns
   ...
   */
  public static Equivalence11<Object> equals() {
    return Equals.INSTANCE;
  }

  /**
   * Returns an equivalence that uses {@code ==} to compare values and {@link
   * System#identityHashCode(Object)} to compute the hash code.  {@link Equivalence11#equivalent}
   * returns {@code true} if {@code a == b}, including in the case that a and b are both null.
   *
   * @since 13.0
   * @since 4.0 (in Equivalences)
   */
  public static Equivalence11<Object> identity() {
    return Identity.INSTANCE;
  }

  static final class Equals extends Equivalence11<Object>
  ...
  static final class Identity extends Equivalence11<Object>
      implements Serializable {
